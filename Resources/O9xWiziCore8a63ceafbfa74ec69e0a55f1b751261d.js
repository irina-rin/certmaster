AC.Widgets.WiziCore8a63ceafbfa74ec69e0a55f1b751261d = (function(c){
  var w =  AC.Widgets.Base.extend({
        ...
        _template : "<script type=\"text/javascript\" src=\"//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js\"></script><script type=\"text/javascript\" src=\"wiziCore/widgetframe.js\"></script> <style>body{margin:0px;padding: 0px;}</style>",
...
w.defaultProps = function(){
    return {width: 200,height:200, x : "100", y: "100", zindex : "auto",
        anchors : {left: true, top: true, bottom: false, right: false}, visible : true,
        opacity : 1, name: "CertInfo", margin : ""
    };
};
...
AC.Core.Widgets().registerExWidget(c, "sections_extensible", "CertInfo", "CertInfo",
    "wiziCore/extWidgets/widget-cog.png");
return w;

})("WiziCore8a63ceafbfa74ec69e0a55f1b751261d");
